# Generated by Django 2.2.27 on 2022-02-23 12:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='ingredients', through='recipes.IngredientRecipeRelation', to='recipes.Ingredient', verbose_name='Ингридиенты')),
