# Generated by Django 2.2.27 on 2022-02-23 08:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='IngridientReceiptRelation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField()),
                ('ingridient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='receipts.Ingridient')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingridients', models.ManyToManyField(related_name='ingridients', through='receipts.IngridientReceiptRelation', to='receipts.Ingridient', verbose_name='Ингридиенты')),
        ...
        migrations.AddField(
            model_name='ingridientreceiptrelation',
            name='receipt',
